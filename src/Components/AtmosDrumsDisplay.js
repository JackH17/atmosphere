        ...
        <div>
            <Stage ref={stageRef} width={stageWidth} height={stageHeight}>
                <Layer>
                    ...
                    <Circle ref={distortionOversamplePlanet} x={widthPercentage(85)} y={heightPercentage(20)} radius={widthPercentage(4)} fill='red' shadowColor="red" shadowBlur={widthPercentage(30)} shadowOpacity={1} draggable onDragMove={getDistortionOversampleDragMove} dragBoundFunc={function(pos){return{x: this.absolutePosition().x, y: this.absolutePosition().y}}} onMouseEnter={handleDistortionOversampleHelper} onMouseLeave={handleDistortionOversampleHelper}/>
                    ...
                    <Text text="WET/DRY" x={widthPercentage(71)} y={heightPercentage(85)} fontSize={widthPercentage(2)} fontFamily={'VT323'} fill='white' opacity={wetDryHelper ? 1 : 0}/>
