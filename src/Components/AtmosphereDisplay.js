        ...
        <div>
            <Stage ref={stageRef} width={stageWidth} height={stageHeight}>
                <Layer>
                    ...
                    <Text text={engaged ? 'off' : 'on'} x={widthPercentage(19.25)} y={heightPercentage(13)} fontSize={widthPercentage(2)} fontFamily={'VT323'} fill={engaged ? 'white' : 'black'} opacity={audioCTX ? 1 : 0}/>
